...
public class ActualizarEstacionBombeo extends PageController {
  ...
  public void doGet(HttpServletRequest request,
    ...
    try {
		  ...
		  module.actualizar(idObj,presionSalidaObj,tipo,capacidadMaximaObj,cantidadBombasObj,encargado,telefono,presionEntradaObj,idAcueductoObj,nombreEstacion);
