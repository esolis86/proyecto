...
public class InsertarValvula extends PageController {
  ...
  public void doGet(HttpServletRequest request,
    ...
    try {
      ...
      module.insertar(tipo,diametroObj,presionMaximaObj,marca,numeroSerie,fechaInstalacion,fechaUltimaInspeccion,estado,idAcueductoObj);
